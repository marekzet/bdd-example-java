 ...
 */
public class PlacingOrderSteps  extends Steps{
    private int customerId;
    private List<OrderItem> orderItems;
    private Order order;
    private OrderServiceImpl orderService;

    public PlacingOrderSteps() {
        customerId = 1;
    ...
    public void thenIShouldSeeOrderSummary () throws OrderException {
        if (order == null) {
